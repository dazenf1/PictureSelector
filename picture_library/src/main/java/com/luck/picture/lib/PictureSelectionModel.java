...
public class PictureSelectionModel {
     ...
     * @param medias
     */
    public void openExternalPreview(int position, List<LocalMedia> medias,Boolean isCanDownload) {
        if (selector != null) {
            selector.externalPicturePreview(position, medias,isCanDownload);
        } else {
            throw new NullPointerException("This PictureSelector is Null");
        }
    }
